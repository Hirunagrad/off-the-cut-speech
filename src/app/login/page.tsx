    ...
    <div className="flex min-h-screen items-center justify-center p-4 bg-background">
      <Card className="w-full max-w-md bg-zinc-900/50 border-zinc-800 backdrop-blur-xl">
        ...
        <CardContent className="space-y-4">
          <Button variant="outline" className="w-full border-zinc-700 hover:bg-zinc-800 text-zinc-100" onClick={handleGoogleAuth}>
        ...
        <CardFooter className="flex flex-col items-center justify-center space-y-2">
          ...
          <Link href="/" className="text-sm text-zinc-500 hover:text-zinc-300 transition-colors mt-4 block">
            &larr; Back to home
          </Link>
        </CardFooter>
      </Card>
